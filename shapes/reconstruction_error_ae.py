...
#for i in [14,16,18,20,25,30,40,50,75,100]:
...
for i in [25,30,40]:
    ...
    sess_none = tf.InteractiveSession()
    ae_test_none=ae.shapes_AE(i, '../../2d_shapes_ae/checkpoints_no_sigmoid/checkpoints_none_'+str(i)+'/2d_shapes_AE-29800', sess_none)
    #ae_test_none.reconstructionInOutandMask(test_images_circle,circle_mask_back, circle_mask_spot,saveName='ae_test2_circle_train_ns_'+str(i)+'dim_none')
    #ae_test_none.reconstructionInOutandMask(test_images_rect,rect_mask_back,rect_mask_spot, saveName='ae_test2_rect_train_ns_'+str(i)+'dim_none')
    ae_test_none.latentSpaceValues(test_images_none, saveName='ae_test2_none_train_ns_'+str(i)+'dim_none')
