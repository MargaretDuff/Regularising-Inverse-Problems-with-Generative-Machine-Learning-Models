# -*- coding: utf-8 -*-
"""
Created on Tue Apr  7 10:44:54 2020
...
class mnist_AE(test_class.generative_model):
    ...
    def __init__(self, latent_dim,alpha,checkpoint, session ):
        ...
        self.z= self.tf_encoder(self.X_in, self.keep_prob)
        ...
        self.loss = tf.reduce_mean(self.img_loss + self.alpha*tf.norm(self.z,1,axis=1))
        ...
        orange=tf.placeholder(dtype=tf.float32, shape=[ 28, 28], name='orange')
        fox=self.tf_encoder(orange)
...
#%%
if __name__=='__main__':
    test=mnistAE(8, 1.0,'./SAE_checkpoints8_1.0/mnist_AE_8_1.0-29800')
    test.elephant()
    test.encode(train_images[600])
    test.latentSpaceValues(train_images[600:602])
